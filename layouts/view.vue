<template>
  <div>
    <div
      class="bg_modal"
      v-if="bgModal"
      @click="(bgModal = false), (langModal = false), (navModal = false)"
    ></div>
    <nav>
      <div class="container">
        <div class="logo">
        ...
        <div class="langunge" :class="{ active: langModal }">
          <div
            class="lang-option"
            @click="(langModal = !langModal), (bgModal = !bgModal)"
          >
            {{ locale }}
          </div>
          <div class="lang-title">
            <NuxtLink
              ...
              class="lang-content"
              ref="language"
              @click="(langModal = false), delLang($event)"
            >
              {{ locale.code }}
            </NuxtLink>
          </div>
        ...
        <div class="set">
          <nuxt-link to="/" class="seti">{{ $t("kirish") }}</nuxt-link>
        </div>
        <div class="nav_btn" @click="(navModal = true), (bgModal = true)">
